...
| เครื่องมือ | สถานะ |
| --- | --- |
| `cargo` | พบที่ `/Users/arthornkhumtoie/opt/anaconda3/bin/cargo` |
| `go` | พบที่ `/Users/arthornkhumtoie/opt/go/bin/go` |
| `python3` | พบที่ `/Library/Frameworks/Python.framework/Versions/3.13/bin/python3` |
| `node` | ยังไม่พบ |
| `php` | ยังไม่พบ |
| `dotnet` | ยังไม่พบ |
| `java` | พบที่ `/usr/bin/java` |
| `dart` | ยังไม่พบ |
| `bash` | พบที่ `/bin/bash` |
| `mvn` | ยังไม่พบ |
